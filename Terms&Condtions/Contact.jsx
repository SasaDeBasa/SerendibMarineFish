...
const ContactForm = () => {
  ...
  const handleCall = () => {
    window.location.href = "tel:+94712528999";
  };
  ...
  return (
    <Box className={classes.root_contactus}>
      ...
      <div className={classes.contact_Container_contactus}>
        ...
        <Typography variant="body2" className={classes.para_contact}>
          <span className={classes.para2}>7:00-6:00 IST Monday-Friday</span>
          <br />
          <span className={classes.para2}>9:00-4:00 IST Saturday</span>
          <br />
          ...
          >
            <div className={classes.SelectOption_contact}>
              ...
              <FormControl className={classes.formField_contact}>
                ...
                >
                  <MenuItem value="e-commerce">Ordering Issue</MenuItem>
                  <MenuItem value="app">Website Issue</MenuItem>
                </Select>
              </FormControl>
            </div>

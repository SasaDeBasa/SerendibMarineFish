          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Serendib Marine Fish Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Serendib Marine Fish Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Serendib Marine Fish will use my information in accordance
              with its

            ...
            <ul className={classes.sideBarMenu}>
              ...
              >
                <li className={classes.sideBarMenuItem}>
                  ...
                  <span className={classes.sideBarMenuItem_text}>Customers</span>
                </li>
              </Link>
              ...
              >
                <li className={classes.sideBarMenuItem}>
                <AddIcon fontSize="large" />
                  <span className={classes.sideBarMenuItem_text}>Add Employee</span>
                </li>
              </Link>
              ...
              >
                <li className={classes.sideBarMenuItem}>
                <AddIcon fontSize="large" />
                  <span className={classes.sideBarMenuItem_text}>Add Supplier</span>
                </li>
              </Link>
